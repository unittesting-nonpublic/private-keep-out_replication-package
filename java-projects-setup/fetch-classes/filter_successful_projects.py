...
successful_df = pd.read_csv('Desktop/test-visibility-checker/successful_nondup.csv')
path = "Desktop/reports-tmp/"
...
#     reportpath = ['Desktop/reports-tmp/' + project + '_all_method_visibility.tsv',
#                   'Desktop/reports-tmp/' + project + '_method_visibility.tsv',
#                   'Desktop/reports-tmp/' + project + '_method_visibility_non_public.tsv']
#     # print(path)
...
# with open('Desktop/test-visibility-checker/empty_project.txt', 'w') as file:
#     # Convert the list elements to strings and write them into the file
#     file.write('\n'.join(str(element) for element in empty_project))

# files = []
# with open('Desktop/test-visibility-checker/empty_project.txt', 'r', newline='') as file:
#         reader = csv.reader(file, delimiter='\n')  # Specify the tab delimiter
#         data = list(reader)  # Read the data from the TSV file into a list of rows
#         for prj in data:
#             if os.path.exists('Desktop/reports-tmp/' + prj[0] + remove_words[0]):
#                 files.append('Desktop/reports-tmp/' + prj[0] + remove_words[0])
#                 os.remove('Desktop/reports-tmp/' + prj[0] + remove_words[0])
#             if os.path.exists('Desktop/reports-tmp/' + prj[0] + remove_words[1]):
#                 files.append('Desktop/reports-tmp/' + prj[0] + remove_words[1])
#                 os.remove('Desktop/reports-tmp/' + prj[0] + remove_words[1])
#             if os.path.exists('Desktop/reports-tmp/' + prj[0] + remove_words[2]):
#                 files.append('Desktop/reports-tmp/' + prj[0] + remove_words[2])
#                 os.remove('Desktop/reports-tmp/' + prj[0] + remove_words[2])
            
# print(len(files))

# check for project's CUT accessibility modifiers
for prj in unique_files:
    prj_df = pd.read_csv('Desktop/reports-tmp/' + 'apache-commons-lang' + remove_words[0])
