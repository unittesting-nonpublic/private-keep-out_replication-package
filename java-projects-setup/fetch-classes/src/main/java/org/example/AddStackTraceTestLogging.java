...
public class AddStackTraceTestLogging extends AbstractProcessor<CtClass<?>> {
    @Override
...
//                                "System.out.println(\"end-trace\");"));
                body.insertBegin(factory.Code().createCodeSnippetStatement("System.out.println(\"\");\n" +
                        "System.out.print(\"TEST START " + fullMethodName(ctMethod) + ",\")"));
...
//                                "System.out.println(\"TEST END " + fullMethodName(ctMethod) + "\")"));
//                    }
//
//                    @Override
