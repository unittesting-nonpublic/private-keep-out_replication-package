...
public class InvokeMaven {
    ...
    private final String[] args = { "clean", "compile -l mvn-compile.log -Drat.skip=true", "test -l mvn-test.log -Drat.skip=true -Dmaven.test.failure.ignore", "dependency:copy-dependencies -l mvn-dependencies.log" };
